...
if (!isset($_POST['x']) && !isset($_FILES['image']['name']) ){
  ...
  $temppath = 'assets/images/profile_pics/'. $userUniqueId .'_temp.jpeg';
...
if(!empty($_FILES['image']['name'])){
  ...
  //Set File name
  $file_temp_name = $userUniqueId.'_original.'.md5(time()).'n'.$type; //the temp file name
  $fullpath = $uploaddir."/".$file_temp_name; // the temp file path
  $file_name = $userUniqueId.'_temp.jpeg'; //$profile_id.'_temp.'.$type; // for the final resized image
...
if (isset($_POST['x'])){
  ...
  $finalname = $userUniqueId.md5(time());
  ...
  DB::query("UPDATE users SET profile_pic='$result_path' WHERE id=?", [$userId]);
  header("Location: ".$userUniqueId);
  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="main_column column">
        ...
        <div id="formExample" class="m-5">

          <p><b> <?=$msg?> </b></p>

          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  enctype="multipart/form-data">
            <div class="form-group">
              <label for="image">Upload something</label>
        ...
        if($imgSrc){ //if an image has been uploaded display cropping area?>
          ...
          <div id="CroppingContainer" class="card m-3">
            <div class="row">
              <div class="col-md-7">
                <div id="CroppingArea" style="width:100%; max-height:400px; position:relative; overflow:hidden; margin:15px;">
              ...
              <div class="col-md-5">
                <div id="InfoArea" style="overflow:hidden; margin:15px;">
                ...
                <div id="CropImageForm" style="margin:15px" >
                ...
                <div id="CropImageForm2" style="margin:15px">
                  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return cancelCrop();">
                    <button type="submit" class="btn btn-danger">Cancel Crop</button>
                  </form>
                </div>
              </div>
            </div>
